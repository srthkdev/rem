    ...
    useEffect(() => {
        ...
        const detectBrokenAuth = async () => {
            try {
                ...
                const isProtectedRoute = ['/project', '/dashboard', '/settings', '/profile'].some(route => 
                    pathname === route || pathname.startsWith(`${route}/`)
                );
                
                const isAuthRoute = ['/auth/sign-in', '/auth/sign-up', '/auth/reset-password'].some(route => 
                ...
                if (isAuthenticated && (isLandingPage || isAuthRoute)) {
                    console.log("AuthProvider: Authenticated user on landing page or auth route, redirecting to /project/new");
                ...
                if (!isAuthenticated && isProtectedRoute) {
                    ...
                    console.log("AuthProvider: Not authenticated but on protected route, letting middleware handle it");
                }
            } catch (error) {
                ...
                if (typeof window !== "undefined") {
                    ...
                    if (storedSession) {
                        try {
                            ...
                            if (sessionData && sessionData.isAuthenticated && sessionData.id && sessionData.email) {
                                ...
                                console.log("AuthProvider: Found invalid session in localStorage, clearing it");
