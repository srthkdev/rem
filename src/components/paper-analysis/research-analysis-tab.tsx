...
export function ResearchAnalysisTab() {
  return (
    <div className="p-4">
      <h3 className="text-lg font-medium mb-4 text-[#262625] dark:text-[#FAF9F6]">
      ...
      <div className="space-y-4">
        ...
        <div className="p-4 rounded-lg bg-[#E3DACC]/20 dark:bg-[#BFB8AC]/10">
          ...
          <p className="text-sm text-[#262625]/70 dark:text-[#BFB8AC]">
            The transformer architecture introduces a novel attention mechanism
            that processes sequential data without recurrence. Key components
            include multi-head self-attention, positional encoding, and
        ...
        <div className="p-4 rounded-lg bg-[#E3DACC]/20 dark:bg-[#BFB8AC]/10">
          ...
          <ul className="text-sm text-[#262625]/70 dark:text-[#BFB8AC] space-y-2">
            <li>
              • Query, Key, Value transformations enable parallel processing
            </li>
            <li>
              • Multi-head attention allows focus on different aspects
              simultaneously
            </li>
        ...
        <div className="p-4 rounded-lg bg-[#E3DACC]/20 dark:bg-[#BFB8AC]/10">
          ...
          <div className="space-y-3">
            <div>
              <p className="text-sm font-medium text-[#262625] dark:text-[#FAF9F6] mb-1">
              ...
              <p className="text-xs text-[#262625]/70 dark:text-[#BFB8AC] mt-1">
                85% faster than RNN-based models
              </p>
            </div>
            <div>
              <p className="text-sm font-medium text-[#262625] dark:text-[#FAF9F6] mb-1">
