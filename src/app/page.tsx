...
export default function Home() {
    ...
    const handleCreateProject = () => {
        ...
        if (selectedPaper) {
            ...
            const returnUrl = encodeURIComponent(`/project/new?paper=${selectedPaper.id}`);
                        ...
                        <section className="py-16 px-4 bg-gradient-to-b from-white to-stone-50 dark:from-[#1C1C1C] dark:to-stone-900">
                            <div className="max-w-7xl mx-auto">
                                ...
                                <p className="text-lg md:text-xl text-center text-[#262625]/70 dark:text-[#BFB8AC] mb-12 max-w-3xl mx-auto">
                                    Transform complex research papers into interactive learning experiences with our AI-powered tools.
                                </p>
                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                                    <div className="bg-white dark:bg-[#262625] p-6 rounded-xl shadow-sm border border-[#E3DACC] dark:border-[#BFB8AC]/30">
                                        <div className="h-12 w-12 bg-[#C96442]/10 rounded-lg flex items-center justify-center mb-4">
                                            <svg className="h-6 w-6 text-[#C96442]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" />
                                            </svg>
                                        </div>
                                        <h3 className="text-xl font-semibold mb-2">Smart Summaries</h3>
                                        <p className="text-[#262625]/70 dark:text-[#BFB8AC]">Get instant, comprehensive summaries of research papers powered by multimodal AI.</p>
                                    </div>
                                    <div className="bg-white dark:bg-[#262625] p-6 rounded-xl shadow-sm border border-[#E3DACC] dark:border-[#BFB8AC]/30">
                                        <div className="h-12 w-12 bg-[#C96442]/10 rounded-lg flex items-center justify-center mb-4">
                                            <svg className="h-6 w-6 text-[#C96442]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        ...
                                        <p className="text-[#262625]/70 dark:text-[#BFB8AC]">Convert key concepts into interactive flashcards for effective learning and retention.</p>
                                    </div>
                                    <div className="bg-white dark:bg-[#262625] p-6 rounded-xl shadow-sm border border-[#E3DACC] dark:border-[#BFB8AC]/30">
                                        <div className="h-12 w-12 bg-[#C96442]/10 rounded-lg flex items-center justify-center mb-4">
                                            <svg className="h-6 w-6 text-[#C96442]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        ...
                                        <h3 className="text-xl font-semibold mb-2">Audio Learning</h3>
                                        <p className="text-[#262625]/70 dark:text-[#BFB8AC]">Listen to AI-generated podcasts summarizing research papers on the go.</p>
                                    </div>
                                    <div className="bg-white dark:bg-[#262625] p-6 rounded-xl shadow-sm border border-[#E3DACC] dark:border-[#BFB8AC]/30">
                                        <div className="h-12 w-12 bg-[#C96442]/10 rounded-lg flex items-center justify-center mb-4">
                                            <svg className="h-6 w-6 text-[#C96442]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        ...
                                        <p className="text-[#262625]/70 dark:text-[#BFB8AC]">Engage in dynamic discussions with AI about any aspect of the research.</p>
                                    </div>
                                </div>
                            </div>
                        </section>
                                ...
                                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                                    <div>
                                        ...
                                        <p className="text-lg text-[#262625]/70 dark:text-[#BFB8AC] mb-6">
                                            REM is revolutionizing how researchers, students, and professionals interact with academic papers. By leveraging the power of arXiv's extensive database and cutting-edge AI technology, we transform complex research into accessible knowledge.
                                        </p>
                                        <div className="space-y-4">
                                            <div className="flex items-start gap-3">
                                                <div className="h-6 w-6 mt-1 text-[#C96442]">✓</div>
                                                <p className="text-[#262625]/70 dark:text-[#BFB8AC]">Access to over 1 million research papers from arXiv</p>
                                            </div>
                                            <div className="flex items-start gap-3">
                                                <div className="h-6 w-6 mt-1 text-[#C96442]">✓</div>
                                                <p className="text-[#262625]/70 dark:text-[#BFB8AC]">Multimodal AI understanding of text, equations, and figures</p>
                                            </div>
                                            <div className="flex items-start gap-3">
                                                <div className="h-6 w-6 mt-1 text-[#C96442]">✓</div>
                                                <p className="text-[#262625]/70 dark:text-[#BFB8AC]">Personalized learning paths and recommendations</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="relative">
                        ...
                        <section className="py-16 px-4 bg-white dark:bg-[#1C1C1C]">
                            <div className="max-w-7xl mx-auto">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                                    ...
                                    <div className="p-6 rounded-xl border border-[#E3DACC] dark:border-[#BFB8AC]/30">
                                        <h3 className="text-xl font-semibold mb-4">Audio Learning</h3>
                                        <ul className="space-y-3 text-[#262625]/70 dark:text-[#BFB8AC]">
                                            <li className="flex items-center gap-2">
                                                <span className="text-[#C96442]">•</span>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                                    <div>
                                        ...
                                        <p className="text-sm text-[#262625]/70 dark:text-[#BFB8AC] mb-4">
                                            Making research accessible through AI-powered learning tools and comprehensive paper analysis.
                                        </p>
                                    </div>
                                    <div>
                                ...
                                <div className="mt-8 pt-8 border-t border-[#E3DACC] dark:border-[#BFB8AC]/30">
                                    <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                                        ...
                                        <div className="flex items-center gap-6">
                                            <a href="https://x.com/sarthxk20" className="text-[#C96442] hover:text-[#C96442]/80">
                                                Twitter
                                            </a>
                                            <a href="https://github.com/srthkdev" className="text-[#C96442] hover:text-[#C96442]/80">
                                                GitHub
                                            </a>
                                            <a href="https://www.linkedin.com/in/sarthak-jain-32b114228/" className="text-[#C96442] hover:text-[#C96442]/80">
                                                Linkedin
                                            </a>
                                        </div>
                                    </div>
